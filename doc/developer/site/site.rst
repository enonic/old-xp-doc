...
An app's site.xml file may optionally contain ``<x-data>`` elements for adding :ref:`mixins`. Adding a mixin this way will add that data on all the content in Content Studio.
