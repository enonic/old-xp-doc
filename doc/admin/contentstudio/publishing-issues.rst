...
The list of publishing issues can be open by clicking |issueicon| icon in the Content Studio header.
...
.. TIP::
   When content is selected in the grid, menu of the Publish button will show the list of open issues this content is a part of.

.. image:: images/issues/publish-menu-issues.png
